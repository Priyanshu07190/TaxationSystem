...
public class SalariedUserFrame {
    private int userId;
    private DatabaseManager dbManager;

    public SalariedUserFrame(int userId) {
        this.userId = userId;
        this.dbManager = DatabaseManager.getInstance();
    }

    public void launch() {
        JFrame frame = new JFrame("Taxation System - Salaried User");
        ...
        quizButton.addActionListener(e -> {
            try {
                ...
                frame.dispose();
                new QuizFrame(userId, "Salaried", "User").launch();
            } catch (Exception ex) {
